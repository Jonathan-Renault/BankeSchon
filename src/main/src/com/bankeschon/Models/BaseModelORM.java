...
public class BaseModelORM {
    ...
    private String getInsertString()
    {
        ...
        //On définit la variable f et lui dire qu'elle récupère les champs déclarés
    ...
    {
        //Définition des variables utilisées lors de la fonction
        ...
        try
        {
            ...
            for (Field f : getClass().getDeclaredFields())
            {
                try {
                    ...
                    {
                        //On ajoute une majuscule en plus des champs sur cette variable
                        String fieldName    = ucFirst(f.getName());
                        String targetMethod = "get" + fieldName; // "getName"

                        //On définit comment on récupère les champs
